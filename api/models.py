...
class ReadSpeed(models.Model):
    ...
    TOUGHNESS_LEVEL = models.CharField(max_length=200, default='Medium',choices=(("Easy","Easy") , ("Medium", "Medium"), ("Hard", "Hard")))
    TYPE_OF = models.CharField('TYPE OF SUBJECT', default='Theoritical',max_length=200, choices=(("Theoritical", "Theoritical"), ("Practical","Practical"), ("Numerical","Numerical") , ("Other","Other")))
    SUBJECT_SYLLABUS = models.CharField(max_length=200, default='Lengthy (600+ pages)',choices=(("Very Lengthy (800+ pages)","Very Lengthy (800+ pages)"), ("Lengthy (600+ pages)", "Lengthy (600+ pages)"), ("Medium (400+ pages)","Medium (400+ pages)"), ("Short", "Short") ))
    PREFERRED_READING= models.CharField('PREFERRED READING TYPE', default='Notes',max_length=200, choices=(("Notes","Notes"), ("Book", "Book"), ("Video","Video"), ("Multiple","Multiple")))
    INTEREST_LEVEL= models.CharField(default='Interesting',max_length=200, choices=(("Very Interesting","Very Interesting"), ("Interesting", "Interesting"), ("Normal","Normal"), ("Boring","Boring")))
    SUPPORTING_KNOWLEDGE= models.CharField(max_length=200,default='None', choices=(("None","None"), ("Beginner", "Beginner"), ("Intermediate","Intermediate"), ("Expert","Expert")))
    ...
    CHECKING_LEVEL= models.CharField(max_length=200,default='Normal', choices=(("Strict","Strict"), ("Normal", "Normal"), ("Lenient","Lenient")))
    ...
    AS_PER= models.FloatField('NO OF HOURS REQUIRED AS PER YOU', default=0,validators=[MinValueValidator(0), MaxValueValidator(200)])
    def __str__(self):
